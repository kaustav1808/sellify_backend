...
router.post('/signin', passport.authenticate("signin", {session: false}), (req,res,done)=>{
...
router.get('/signout',passport.authenticate("verify_token", {session: false}), (req, res, done)=>{
